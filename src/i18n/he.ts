...
export const he: Messages = {
  ...
  home: {
    ...
    heroTitleCandidate: "מצאו עבודה דרך שיחה — בלי חיפוש אינסופי",
    heroTitleEmployer: "גייסו דרך שיחה — בלי סינון אינסופי",
    pillarChatTitle: "שיחה טבעית",
    pillarChatBody: "ספרו את הסיפור שלכם בשיחה אנושית — בלי טפסים נוקשים.",
    pillarMatchTitle: "התאמה חכמה",
    pillarMatchBody: "ה-AI מבין הקשר ומציג התאמות רלוונטיות באמת.",
    pillarApprovedTitle: "רק מה שאושר",
    pillarApprovedBody: "רואים רק הזדמנויות שאושרו עבורכם — בלי רעש.",
    ctaCardTitle: "בואו נתחיל",
    ctaCardHint: "התחברו והתחילו שיחה ראשונה תוך פחות מדקה.",
    switchToEmployer: "מגייסים? לכניסת מעסיקים",
    switchToCandidate: "מחפשים עבודה? לכניסת מועמדים",
  },
  devLogin: {
  ...
  employee: {
    subtitle: "העלאת קו״ח · שיחה חכמה · פרופיל שמתעדכן",
    localMode: " · מצב מקומי (בלי מפתח Gemini)",
    chatTab: "הגשת מועמדות",
    jobsTab: "ראיונות שנקבעו ({count})",
    chatPlaceholder: "למשל: אני מחפש/ת תפקיד בתחום מכירות, חשוב לי גמישות בשעות…",
    flowTitle: "תהליך מציאת עבודה",
    stepCv: "העלאת קו״ח",
    stepChat: "שיחה עם הסוכן",
    stepProfile: "ראיונות שנקבעו",
    cvStepHint: "השלב הראשון — מעלים קו״ח ומפעילים את הצ׳אט",
    profileStepHint: "מתעדכן אוטומטית מקו״ח ומשיחה",
    applicationProgress: "רמת התאמה",
    applicationProgressLine: "{percent}% רמת התאמה",
    applicationProgressHint: "העלה קורות חיים וענה על השאלות בצאט כדי להעלות את סיכויי קבלה למשרה",
    cvUploadedMessage: "קורות חיים: {fileName}",
    chatHeroTitle: "שיחה חכמה עם הסוכן",
    chatHeroLead: "אחרי העלאת קו״ח — ספרו מה אתם מחפשים, והסוכן ישאל שאלות כדי לחדד ולהשלים את הפרופיל.",
    chatLockedTitle: "הצ׳אט ייפתח אחרי העלאת קו״ח",
    chatLockedBody: "העלו קורות חיים כדי להתחיל שיחה. הסוכן יקרא את הקו״ח וישאל שאלות ממוקדות.",
  },
  employer: {
  ...
  chat: {
    ...
    attachCv: "עדכון קורות חיים",
    cvRequired: "העלו קורות חיים כדי להתחיל שיחה עם הסוכן.",
    cvRequiredEmpty: "העלו קורות חיים בצד כדי לפתוח את הצ׳אט ולהתחיל שיחה.",
  ...
  profile: {
    ...
    yourCardWithPercent: "הפרופיל שלך {percent}%",
    hideCard: "הסתר",
    showDetails: "פרטים",
    hideDetails: "הסתר",
